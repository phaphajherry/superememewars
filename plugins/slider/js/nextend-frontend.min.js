...
/Edge\/\d./i.test(navigator.userAgent) || (void 0 !== element.style.webkitFilter ? window.n2FilterProperty = "webkitFilter" : void 0 !== element.style.filter && (window.n2FilterProperty = "filter")), N2D("Base64", function() {
    var e = function(e) {
            e = e.replace(/\r\n/g, "\n");
    ...
    return N2Classes.Base64 = {
        ...
        encode: function(t) {
            var n, i, o, r, a, s, T, l = "",
                S = 0;
            for (t = e(t); S < t.length;) n = t.charCodeAt(S++), i = t.charCodeAt(S++), o = t.charCodeAt(S++), r = n >> 2, a = (3 & n) << 4 | i >> 4, s = (15 & i) << 2 | o >> 6, T = 63 & o, isNaN(i) ? s = T = 64 : isNaN(o) && (T = 64), l = l + this._keyStr.charAt(r) + this._keyStr.charAt(a) + this._keyStr.charAt(s) + this._keyStr.charAt(T);
            return l
        },
        decode: function(e) {
            var n, i, o, r, a, s, T, l = "",
                S = 0;
            for (e = e.replace(/[^A-Za-z0-9\+\/\=]/g, ""); S < e.length;) r = this._keyStr.indexOf(e.charAt(S++)), a = this._keyStr.indexOf(e.charAt(S++)), s = this._keyStr.indexOf(e.charAt(S++)), T = this._keyStr.indexOf(e.charAt(S++)), n = r << 2 | a >> 4, i = (15 & a) << 4 | s >> 2, o = (3 & s) << 6 | T, l += String.fromCharCode(n), 64 != s && (l += String.fromCharCode(i)), 64 != T && (l += String.fromCharCode(o));
            return l = t(l)
        }
    }, N2Classes.Base64
}), ! function(e, t) {
    e(function() {
        ...
        return r.FALLBACK_PHONE = "UnknownPhone", r.FALLBACK_TABLET = "UnknownTablet", r.FALLBACK_MOBILE = "UnknownMobile", a = "isArray" in Array ? Array.isArray : function(e) {
            ...
            function() {
                var e, t, n, o, T, l, S = r.mobileDetectRules;
                for (e in S.props)
                    if (s.call(S.props, e)) {
                        for (t = S.props[e], a(t) || (t = [t]), T = t.length, o = 0; T > o; ++o) n = t[o], l = n.indexOf("[VER]"), l >= 0 && (n = n.substring(0, l) + "([\\w._\\+]+)" + n.substring(l + 5)), t[o] = new RegExp(n, "i");
                        S.props[e] = t
                    }
                ...
                var n, i, o, a, T = r.mobileDetectRules.props;
                if (s.call(T, e))
                ...
                if (e.mobile === t) {
                    var a, s, T;
                    return (s = r.findMatch(r.mobileDetectRules.tablets, n)) ? (e.mobile = e.tablet = s, void(e.phone = null)) : (a = r.findMatch(r.mobileDetectRules.phones, n)) ? (e.mobile = e.phone = a, void(e.tablet = null)) : void(r.isMobileFallback(n) ? (T = o.isPhoneSized(i), T === t ? (e.mobile = r.FALLBACK_MOBILE, e.tablet = e.phone = null) : T ? (e.mobile = e.phone = r.FALLBACK_PHONE, e.tablet = null) : (e.mobile = e.tablet = r.FALLBACK_TABLET, e.phone = null)) : r.isTabletFallback(n) ? (e.mobile = e.tablet = r.FALLBACK_TABLET, e.phone = null) : e.mobile = e.tablet = e.phone = null)
                }
    ...
    (function() {
        ...
        function(e) {
            ...
            var i = document.documentElement,
                o = function() {};
            i.addEventListener ? o = function(e, t, n) {
                e.addEventListener(t, n, !1)
            } : i.attachEvent && (o = function(e, t, i) {
            ...
            var r = function() {};
            i.removeEventListener ? r = function(e, t, n) {
                e.removeEventListener(t, n, !1)
            } : i.detachEvent && (r = function(e, n, i) {
        ...
        function(e, t) {
            ...
            function T(t, n, i) {
                ...
                "string" == typeof t && (t = document.querySelectorAll(t)), this.elements = s(t), this.options = r({}, this.options), "function" == typeof n ? i = n : r(this.options, n), i && this.on("always", i), this.getImages(), e && (this.jqDeferred = new e.Deferred);
                var o = this;
                setTimeout(function() {
                    o.check()
                })
            ...
            T.prototype = new i, T.prototype.options = {}, T.prototype.getImages = function() {
                this.images = [];
            ...
            var b = n.getComputedStyle || function(e) {
            ...
            return T.prototype.addImage = function(e) {
            ...
            }, l.prototype = new i, l.prototype.check = function() {
            ...
            }, S.prototype = new l, S.prototype.check = function() {
                ...
                e && (e.fn.n2imagesLoaded = function(t, n) {
    ...
    e.event.special.universalclick = {
        add: function(t) {
            var n = e(this),
                ...
                o = null,
                r = function() {
                    i = !0, o && clearTimeout(o), o = setTimeout(function() {
                        i = !1
                    }, 400)
                },
                a = 0,
            ...
            try {
                ...
                n[0]._touchstart = T, n[0].addEventListener("touchstart", T, window.n2const.passiveEvents ? {
                    passive: !0
                } : !1), n.on("touchend.universalclick", function(e) {
                    Math.abs(e.originalEvent.changedTouches[0].clientX - a) < 10 && Math.abs(e.originalEvent.changedTouches[0].clientY - s) < 10 && (i || (r(), t.handler.apply(this, arguments)))
        ...
        remove: function() {
            ...
            try {
                this.removeEventListener("touchstart", this._touchstart, window.n2const.passiveEvents ? {
                    passive: !0
                } : !1), delete this._touchstart
            } catch (t) {}
        }
    };
    var n = [],
        i = !1,
        o = function(t) {
            for (var i = e(t.target), o = n.length - 1; o >= 0; o--) n[o].is(i) || 0 != n[o].find(i).length || n[o].trigger("universal_leave")
        },
        r = function() {
            if (!i) {
                i = !0;
                try {
                    e("body").get(0).addEventListener("touchstart", o, window.n2const.passiveEvents ? {
                        passive: !0
                    } : !1)
                } catch (t) {}
            }
        ...
        a = function() {
            if (i) {
                try {
                    e("body").get(0).removeEventListener("touchstart", o, window.n2const.passiveEvents ? {
                        passive: !0
                    } : !1)
                } catch (t) {}
                i = !1
    ...
    e.event.special.universalenter = {
        add: function(t) {
            var n = e(this),
                ...
                o = null,
                r = function() {
                    i = !0, o && (clearTimeout(o), o = null), o = setTimeout(function() {
                        i = !1
                    }, 400)
                },
                a = !1;
            ...
            var l = null,
                S = null,
                u = function(e) {
                    i || ("touchstart" === e.type ? (r(), a ? l ? n.trigger("universal_leave") : (s(n), t.handler.apply(this, arguments), l = setTimeout(function() {
                        n.trigger("universal_leave")
                    }, 5e3)) : (l && (clearTimeout(l), l = null), s(n), t.handler.apply(this, arguments), l = setTimeout(function() {
                        n.trigger("universal_leave")
                    }, 5e3))) : (S && clearTimeout(S), t.handler.apply(this, arguments), n.on("mouseleave.universalleave", function() {
                        n.off(".universalleave"), a ? n.trigger("universalleave") : S = setTimeout(function() {
                            n.trigger("universalleave"), S = null
                        }, 800)
                    })))
                };
            n.on("universal_leave.universalenter", function(e) {
                e.stopPropagation(), clearTimeout(l), l = null, T(n), n.trigger("universalleave")
            }).on("mouseenter.universalenter", u);
            try {
                n[0]._mouseenter = u, n[0].addEventListener("touchstart", u, window.n2const.passiveEvents ? {
                    passive: !0
                } : !1)
            } catch (c) {}
        },
        remove: function() {
            ...
            try {
                this.removeEventListener("touchstart", this._mouseenter, window.n2const.passiveEvents ? {
                    passive: !0
                } : !1), delete this._mouseenter
            } catch (t) {}
        }
    }
    ...
    function n(n, r) {
        ...
        function s(e, t, n, i) {
            return t ? (e.addEventListener ? e.addEventListener(t, n, i) : e.attachEvent("on" + t, n), {
                remove: function() {
                    T(e, t, n, i)
                }
            }) : void 0
        ...
        function S(e) {
            if (p = {
                ...
                }, p.time - H[H.length - 1].time) {
                for (var t = 0; t < H.length - 1 && p.time - H[t].time > 80; t++);
                m = {
                    x: (p.x - H[t].x) / (p.time - H[t].time),
                    y: (p.y - H[t].y) / (p.time - H[t].time)
                }, H.length >= 5 && H.shift(), H.push({
                    x: p.x,
                    y: p.y,
                    time: p.time
                })
        ...
        function u(e, n) {
            o || (C = !0, h = n, g[h](e) || I(e.target) || (o = !0, s(document, v[h][1], c, "touchmove" == v[h][1] ? {
                passive: !1
            } : !1), s(document, v[h][2], d, !1), s(document, v[h][3], d, !1), P.preventDefault && h && l(e), f = {
        ...
        function c(e) {
            "x" == P.axis && (!P.preventScroll && A || g[h](e)) || I(e.target) || (S(e), (Math.abs(p.x) > P.clickTolerance || Math.abs(p.y) > P.clickTolerance) && (C = !1), A === t && 3 !== h && (A = Math.abs(p.x) < Math.abs(p.y) && !P.preventScroll) || P.move(e, f, p, m, G) && P.preventDefault && l(e))
        }

        function d(e) {
            h && S(e), !C && e.target && e.target.blur && e.target.blur(), T(document, v[h][1], c, "touchmove" == v[h][1] ? {
                passive: !1
            } : !1), T(document, v[h][2], d, !1), T(document, v[h][3], d, !1), P.end(e, f, p, m, G), G = !1, o = !1
        }

        function b() {
            (!n2const.isIOS || n2const.IOSVersion < 10) && B.push(s(document, "scroll", function(e) {
                G = !0
            })), B.push(s(n, v[E][0], function(e) {
                u(e, E)
            })), B.push(s(n, "dragstart", l)), P.mouse && !E && B.push(s(n, v[3][0], function(e) {
                u(e, 3)
            })), B.push(s(n, "click", function(e) {
                C ? P.click(e) : l(e)
            }))
        }
        var P = {
        ...
        var A, G, h, M = {
            ...
            g = [function(e) {
                ...
                return !e.isPrimary || e.buttons && 1 !== e.buttons || !P.mouse && "touch" !== e.pointerType && "pen" !== e.pointerType
            }, function(e) {
                return !e.isPrimary || e.buttons && 1 !== e.buttons || !P.mouse && e.pointerType !== e.MSPOINTER_TYPE_TOUCH && e.pointerType !== e.MSPOINTER_TYPE_PEN
            }, function(e) {
                return e.buttons && 1 !== e.buttons
            }],
            I = function(t) {
                var n = t.tagName;
                return !("INPUT" != n && "TEXTAREA" != n && "SELECT" != n && "BUTTON" != n && "VIDEO" != n && !e(t).hasClass("n2-scrollable") && !e(t).closest(".n2-scrollable").length)
            };
        return b(), {
            ...
            kill: function() {
                for (var e = B.length - 1; e >= 0; e--) B[e].remove()
            }
        }
    }
    var i = function() {
...
"undefined" != typeof window.Modernizr && (tmpModernizr = window.Modernizr), ! function(e, t, n) {
    function i(e, t) {
        return typeof e === t
    }
    ...
    function o() {
        ...
        for (var T in M)
            if (M.hasOwnProperty(T)) {
                if (e = [], t = M[T], t.name && (e.push(t.name.toLowerCase()), t.options && t.options.aliases && t.options.aliases.length))
                    for (n = 0; n < t.options.aliases.length; n++) e.push(t.options.aliases[n].toLowerCase());
                for (o = i(t.fn, "function") ? t.fn() : t.fn, r = 0; r < e.length; r++) a = e[r], s = a.split("."), 1 === s.length ? p[s[0]] = o : (!p[s[0]] || p[s[0]] instanceof Boolean || (p[s[0]] = new Boolean(p[s[0]])), p[s[0]][s[1]] = o), v.push((o ? "" : "no-") + s.join("-"))
            }
    }
    ...
    function a(e) {
        ...
        if (D && (t = t.baseVal), p._config.enableJSClass) {
            new RegExp("(^|\\s)" + n + "no-js(\\s|$)")
        }
        p._config.enableClasses && (t += " " + n + e.join(" " + n), D ? H.className.baseVal = t : H.className = t)
    }
    ...
    function s(e, t) {
        if ("object" == typeof e)
            ...
            var i = e.split("."),
                o = p[i[0]];
            if (2 == i.length && (o = o[i[1]]), "undefined" != typeof o) return p;
            t = "function" == typeof t ? t() : t, 1 == i.length ? p[i[0]] = t : (!p[i[0]] || p[i[0]] instanceof Boolean || (p[i[0]] = new Boolean(p[i[0]])), p[i[0]][i[1]] = t), a([(t && 0 != t ? "" : "no-") + i.join("-")]), p._trigger(e, t)
        }
        return p
    }
    ...
    function u(e, n, i, o) {
        var r, a, s, T, u = "modernizr",
            c = l("div"),
            d = S();
        if (parseInt(i, 10))
            for (; i--;) s = l("div"), s.id = o ? o[i] : u + (i + 1), c.appendChild(s);
    ...
    function P(t, i) {
        ...
        if ("CSS" in e && "supports" in e.CSS) {
            for (; o--;)
                if (e.CSS.supports(b(t[o]), i)) return !0;
            return !1
        }
    ...
    function A(e, t, o, a) {
        ...
        for (var u, c, d, b, A, G = ["modernizr", "tspan"]; !V.style;) u = !0, V.modElem = l(G.shift()), V.style = V.modElem.style;
        for (d = e.length, c = 0; d > c; c++)
            if (b = e[c], A = V.style[b], T(b, "-") && (b = r(b)), V.style[b] !== n) {
                if (a || i(o, "undefined")) return s(), "pfx" == t ? b : !0;
                try {
                    V.style[b] = o
                } catch (h) {}
                if (V.style[b] != A) return s(), "pfx" == t ? b : !0
            }
        return s(), !1
    }
    ...
    function G(e, t, n, o, r) {
        ...
        return i(t, "string") || i(t, "undefined") ? A(s, t, o, r) : (s = (e + " " + C.join(a + " ") + a).split(" "), d(s, t, n))
    }
    ...
    var v = [],
        ...
        I = "supportsCSS" in e;
    p.addTest("supports", g || I);
    var D = "svg" === H.nodeName.toLowerCase();
    f._l = {}, f.on = function(e, t) {
        ...
        function o(e, t) {
            var n = M.elements;
            "string" != typeof n && (n = n.join(" ")), "string" != typeof e && (e = e.join(" ")), M.elements = n + " " + e, l(t)
        }
        ...
        function a(e, n, i) {
            ...
            i || (i = r(n));
            var o;
            return o = i.cache[e] ? i.cache[e].cloneNode() : P.test(e) ? (i.cache[e] = i.createElem(e)).cloneNode() : i.createElem(e), !o.canHaveChildren || b.test(e) || o.tagUrn ? o : i.frag.appendChild(o)
        }

        function s(e, n) {
            if (e || (e = t), u) return e.createDocumentFragment();
            n = n || r(e);
            for (var o = n.frag.cloneNode(), a = 0, s = i(), T = s.length; T > a; a++) o.createElement(s[a]);
            return o
        }
        ...
        function l(e) {
            e || (e = t);
            var i = r(e);
            return !M.shivCSS || S || i.hasCSS || (i.hasCSS = !!n(e, "article,aside,dialog,figcaption,figure,footer,header,hgroup,main,nav,section{display:block}mark{background:#FF0;color:#000}template{display:none}")), u || T(e, i), e
        }
        var S, u, c = "3.7.3",
            d = e.html5 || {},
        ...
        e.html5 = M, l(t), "object" == typeof module && module.exports && (module.exports = M)
    }("undefined" != typeof e ? e : this, t);
    var y = f._config.usePrefixes ? B.split(" ") : [];
    f._cssomPrefixes = y;
    var w = function(t) {
        var i, o = m.length,
            r = e.CSSRule;
    ...
    p._q.unshift(function() {
        ...
        return A([e], n, t, i)
    }, f.testAllProps = G, f.prefixed = function(e, t, n) {
        return 0 === e.indexOf("@") ? w(e) : (-1 != e.indexOf("-") && (e = r(e)), t ? G(e, t, n) : G(e, "pfx"))
    }, f.testAllProps = h, p.addTest("csstransforms3d", function() {
        var e = !!h("perspective", "1px", !0),
            t = p._config.usePrefixes;
        if (e && (!t || "webkitPerspective" in H.style)) {
            var n, i = "#modernizr{width:0;height:0}";
            p.supports ? n = "@supports (perspective: 1px)" : (n = "@media (transform-3d)", t && (n += ",(-webkit-transform-3d)")), n += "{#modernizr{width:7px;height:18px;margin:0;padding:0;border:0}}", L(i + n, function(t) {
                e = 7 === t.offsetWidth && 18 === t.offsetHeight
            })
        }
        return e
    }), o(), a(v), delete f.addTest, delete f.addAsyncTest;
    for (var O = 0; O < p._q.length; O++) p._q[O]();
    e.Modernizr = p
}(window, document), Modernizr.addTest("csstransformspreserve3d", function() {
    var e, t = Modernizr.prefixed("transformStyle"),
        n = "preserve-3d";
    return t ? (t = t.replace(/([A-Z])/g, function(e, t) {
        return "-" + t.toLowerCase()
    }).replace(/^ms-/, "-ms-"), Modernizr.testStyles("#modernizr{" + t + ":" + n + ";}", function(n, i) {
        window.getComputedStyle ? (e = getComputedStyle(n, null), e = e ? e.getPropertyValue(t) : "") : e = ""
    }), e === n) : !1
}), window.nModernizr = window.Modernizr, tmpModernizr && (window.Modernizr = tmpModernizr), N2D("nextend-frontend");