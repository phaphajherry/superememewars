(function() {
    ...
    return i.prototype.whenWithProgress = function(e) {
        ...
        if ("resolved" != i[0].state()) {
            var o = setTimeout(t.proxy(function() {
                this.slider.load.showSpinner("backgroundImage" + e[0].index), o = null
            }, this), 50);
            t.when.apply(t, i).done(t.proxy(function() {
                o ? (clearTimeout(o), o = null) : this.slider.load.removeSpinner("backgroundImage" + e[0].index), setTimeout(function() {
                    a.resolve()
                }, 100)
            }, this))
    ...
    function i(e, i) {
        this.parameters = t.extend({
            fade: 1,
            scroll: 0
        }, i), this.deferred = t.Deferred(), this.smartSlider = e, this.spinnerKey = "fadePlaceholder", this.id = e.sliderElement.attr("id"), this.$window = t(window)
    }
    return i.prototype.start = function() {
        if (this.spinner = t("#" + this.id + "-spinner"), this.parameters.scroll) {
            var e = t(window);
        ...
        this.spinnerKey = t, this.spinner.appendTo(this.loadingArea).css("display", "")
    }, i.prototype.removeSpinner = function(t) {
        this.spinnerKey == t && (this.spinner.detach(), this.spinnerKey = "")
    }, i
    ...
    return s.prototype.add = function(t, e, i, s) {
        ...
        var i = t.$el[0].getBoundingClientRect(),
            s = i.height > .7 * e,
            n = !0;
        "lazy" === t.mode ? s && (i.bottom < 0 || i.top >= i.height) ? n = !1 : !s && (i.bottom - i.height < 0 || i.top - e + i.height >= 0) && (n = !1) : "instant" === t.mode && (n = i.top - e < 0 && i.top + i.height > 0), n === !1 ? "hidden" !== t.state && ("function" == typeof t.onHide && t.onHide(), t.state = "hidden") : "visible" !== t.state && ("function" == typeof t.onVisible && t.onVisible(), t.state = "visible")
    }, new s
    ...
    return i.prototype.makeReady = function(t, e) {
        ...
        if (n.length > 1) {
            ...
            var a = s.data("eventCounter") || 0;
            i = n[a], a++, a > n.length - 1 && (a = 0), s.data("eventCounter", a)
        }
        r.triggerHandler(i)
    ...
    function SmartSliderAbstract(t, e) {
        this.editor = null, this.startedDeferred = $.Deferred(), t instanceof $ && (t = "#" + t.attr("id")), N2D(t, $.proxy(function() {
            return this
        }, this));
        var i = t.substr(1);
        this.elementID = i, window[i] && window[i] instanceof SmartSliderAbstract && $.contains("body", window[i].sliderElement) || (this.isAdmin = !!e.admin, this.id = parseInt(i.replace("n2-ss-", "")), window[i] = this, this.readyDeferred = $.Deferred(), this.waitForExists(i, e))
    }
    return SmartSliderAbstract.prototype.kill = function() {
        ...
        if (this.killed = !1, this.responsive = !1, this.mainAnimationLastChangeTime = 0, this.currentSlide = null, this.currentRealSlide = null, this.staticSlide = !1, this.isShuffled = !1, this.slides = [], this.visibleSlides = 1, this.sliderElement = $sliderElement.data("ss", this), this.needBackgroundWrap = !1, this.parameters = $.extend({
                admin: !1,
                playWhenVisible: 1,
                playWhenVisibleAt: .5,
                perspective: 1e3,
        ...
        this.visibleDeferred = $.Deferred(), !this.isAdmin && this.parameters.playWhenVisible ? this.ready($.proxy(function() {
        ...
        var t = $(window).scrollTop(),
            e = $(window).height(),
            i = this.sliderElement.offset().top,
            s = i + Math.min(this.sliderElement.height(), e) * (1 - this.parameters.playWhenVisibleAt),
            n = i + Math.min(this.sliderElement.height(), e) * this.parameters.playWhenVisibleAt;
        (this.isAdmin || s >= t && t + e >= n) && ($(window).off("scroll.n2-ss-visible" + this.id + " resize.n2-ss-visible" + this.id), this.visibleDeferred.resolve())
        ...
        if (t === undefined && (t = 0), this.responsive.parameters.focusUser && !t || this.responsive.parameters.focusAutoplay && t) {
            ...
            $(window).scrollTop() !== i ? $("html, body").animate({
                scrollTop: i
            }, 400, $.proxy(function() {
                e.resolve()
            }, this)) : e.resolve()
            ...
            return $.when(this.backgrounds.preLoadSlides(this.getVisibleSlides(this.slides[t])), this.focus(i)).done($.proxy(function() {
                if (this.mainAnimationLastChangeTime <= n) {
                    ...
                    if ("ended" === r) {
                        ...
                        "undefined" != typeof s && (a = s), this._changeTo(t, e, i, s), a.changeTo(this.currentSlide, this.slides[t], e, i), this._changeCurrentSlide(t)
        ...
        "mainInStart" === t.inAnimation ? r.one("mainAnimationStartIn.layers", $.proxy(function() {
            ...
            r.off("mainAnimationStartInCancel.layers"), r.data("slide").playIn()
        }, this)), "skippable" === t.mode && a.on("mainAnimationCompleteOut.layers", $.proxy(function() {
            a.off("mainAnimationCompleteOut.layers"), t.playOnce ? this.parameters.foreverLayerAnimation || a.data("slide").pause() : a.data("slide").reset()
    ...
    return SmartSliderWidgets.prototype.setState = function(t, e) {
        ...
        if (this.widgets[t].length) {
            ...
            e && this.states["hide." + t] !== undefined && this.states["hide." + t] && (e = !1), this.widgets[t].toggleClass("n2-ss-widget-hidden", !e)
        }
    }, SmartSliderWidgets.prototype.onReady = function() {
        this.dimensions = this.slider.dimensions, this.$vertical = this.sliderElement.find('[data-position="above"],[data-position="below"]').not(".nextend-shadow");
        var t = !1;
        ...
        if (t) {
            ...
            h(null, this.slider.currentRealSlide.index), this.slider.sliderElement.on("sliderSwitchTo", h)
        }
    ...
    return i.prototype.setToStarterSlide = function(t) {}, i.prototype.enableReverseMode = function() {
        ...
        if (this.isTouch) e.onOutAnimationsPlayed();
            ...
            var a = t.Deferred();
            a.done(t.proxy(function() {
                this.play()
            }, this.timeline)), this.preChangeToPlay(a, e, i)
        }
    ...
    return i.prototype.addVisiblePlay = function() {
    ...
    }, i.prototype.getAnimation = function(i, a, o) {
        if (!a.elements.image) return !1;
        ...
        c.from.transformOrigin === e && (c.from.transformOrigin = l.transformOrigin), (n2const.isFirefox || n2const.isIE <= 11) && NextendTween.set(a.elements.image.$background.parent(), {
            rotationZ: "0.001deg"
        }), NextendTween.set(a.elements.image.$background, {
        ...
        return "undefined" != typeof c.from.x && (c.from.x *= o.slideW), "undefined" != typeof c.from.y && (c.from.y *= o.slideH), "undefined" != typeof c.to.x && (c.to.x *= o.slideW), "undefined" != typeof c.to.y && (c.to.y *= o.slideH), new s(a.elements.image.$background, n[h], c.from, c.to)
    ...
    return i.prototype.onReady = function() {
        ...
        for (var a in this.deferredsMediaPlaying) this.deferredsMediaPlaying[a].resolve()
        ...
        return .3 > i && i < this.parameters.duration && (i = this.parameters.duration), i
    ...
    return i.prototype.switchState = function() {
        ...
        this.forceFullpage && (this.responsive.parameters.type = "fullpage", this.responsive.parameters.upscale = !0, this.responsive.parameters.forceFull = !1, this._marginLeft = this.responsive.containerElement[0].style.marginLeft, this.responsive.containerElement.css(n2const.rtl.marginLeft, 0)), this.fullParent.css({
            width: "100%",
            height: "100%",
        ...
        this.isDocumentInFullScreenMode() ? (this.slider.sliderElement.triggerHandler("n2FullScreen"), t("html").addClass("n2-in-fullscreen"), this.isFullScreen = !0, t(window).trigger("resize")) : this.forceFullpage && (this.responsive.parameters.type = this._type, this.responsive.parameters.upscale = this._upscale, this.responsive.parameters.forceFull = this._forceFull, this.responsive.parameters.minimumHeightRatio = this._minimumHeightRatio, this.responsive.parameters.maximumHeightRatio = this._maximumHeightRatio, this.responsive.containerElement.css(n2const.rtl.marginLeft, this._marginLeft), this.fullParent.css({
            width: "",
            height: "",
            backgroundColor: ""
    ...
    function i(e) {
        this.preventScroll = !1, this._preventScrollTimeout = null, this.slider = e, e.sliderElement.on("DOMMouseScroll mousewheel", t.proxy(this.onMouseWheel, this)), e.sliderElement.on("mainAnimationComplete", t.proxy(this.clearScrollTimeout, this)), e.controls.scroll = this
    }
    return i.prototype.onMouseWheel = function(t) {
        if (this.preventScroll) this.preventScrollTimeout(t);
        else {
            var e = !1;
            t.originalEvent && (t.originalEvent.wheelDelta && (e = t.originalEvent.wheelDelta / -1 < 0), t.originalEvent.deltaY && (e = t.originalEvent.deltaY < 0), t.originalEvent.detail && (e = t.originalEvent.detail < 0)), e ? this.slider.previous() && this.preventScrollTimeout(t) : this.slider.next() && this.preventScrollTimeout(t)
        }
    }, i.prototype.clearScrollTimeout = function() {
        null !== this._preventScrollTimeout && clearTimeout(this._preventScrollTimeout), this.preventScroll = !1, this._preventScrollTimeout = null
    }, i.prototype.preventScrollTimeout = function(e) {
        null !== this._preventScrollTimeout && clearTimeout(this._preventScrollTimeout), this.preventScroll = !0, e.preventDefault(), this._preventScrollTimeout = setTimeout(t.proxy(function() {
            this.preventScroll = !1, this._preventScrollTimeout = null
        }, this), 400)
    }, i
    ...
    function i(e, i, s) {
        ...
        var r = t.proxy(function() {
            ...
            this._animation.isNoAnimation ? N2Classes.EventBurrito(this.swipeElement.get(0), {
                ...
                move: function(e, i, s, r, a) {
                    var o = t._direction.measure(s);
                    if (!a && "unknown" != o && null === t.currentAnimation) {
                        if ("ended" != t._animation.state) return !1;
                        t.distance = [0], t.swipeElement.addClass("n2-grabbing"), t.currentAnimation = {
                            direction: o
                        };
                        var l = t.slider.isChangePossible(t._direction[o]);
                    ...
                    if (null !== t.currentAnimation) {
                        var a = r ? 0 : t.measureRealDirection();
                        a && t.slider[t._direction[t.currentAnimation.direction]](), t.swipeElement.removeClass("n2-grabbing"), t.currentAnimation = null
                    }
                ...
                move: function(e, i, s, r, a) {
                    ...
                    if (!a && "unknown" != o && null === t.currentAnimation) {
                        ...
                        var l = t.slider[t._direction[o]](!1);
                    ...
                    if (null !== t.currentAnimation) {
                        var a = r ? 0 : t.measureRealDirection(),
                            o = t._animation.timeline.progress();
                        1 != o && t._animation.setTouchEnd(a, t.currentAnimation.percent, s.time), t.swipeElement.removeClass("n2-grabbing"), t._animation.setTouch(!1), t.currentAnimation = null
                    }
                    Math.abs(s.x) < 10 && Math.abs(s.y) < 10 ? t.onTap(e) : nextend.preventClick()
                }
            })
        ...
        if (navigator.userAgent.toLowerCase().indexOf("android") > -1) {
            var a = this.swipeElement.parent();
            1 != a.css("opacity") ? this.swipeElement.parent().one("transitionend", r) : r()
        } else r();
    ...
    function s(t, e, i, s, n, r, a) {
        this.status = u.NOT_INITIALIZED, this.single = !1, this.transformOrigin = "50% 50% 0", this._counter = 0, this.inAnimation = null, this.timeline = null, this.outAnimation = null, this.layers = t, this.$layer = e, this.$animatableElement = i, this.animations = s, this.timelineMode = a, this.transformOrigin = s.transformOriginLoop.split("|*|").join("% ") + "px", this.repeatCount = s.repeatCount, 0 == this.repeatCount && "linear" == a && (this.repeatCount = 1), this.repeatStartDelay = Math.max(0, s.repeatStartDelay), this.repeatSelfOnly = s.loopRepeatSelfOnly, this.refresh(n, r)
    }
    var n = {
            NOT_INITIALIZED: -1,
            INITIALIZED: 1,
        ...
        d = function(t, e, i) {
            NextendTween.to(t, e, h(i))
        },
        p = function(t, e, i, s) {
            t.to(e, i, h(s))
        },
        c = function(t, e, i, s, n) {
            t.fromTo(e, i, h(s), h(n))
        };
    i.prototype.setLinear = function(e, i, s) {
        this.timelineMode = "linear", this.animations = null;
        var r = e.animations.getData();
        "object" == typeof r && (this.animations = t.extend({
            repeatable: 0,
            "in": [],
            specialZeroIn: 0,
            ...
            outPlayEvent: "",
            instantOut: 1
        }, r), this.transformOriginIn = this.animations.transformOriginIn.split("|*|").join("% ") + "px", this.transformOriginOut = this.animations.transformOriginOut.split("|*|").join("% ") + "px", this.repeatable = this.animations.repeatable ? 1 : 0, this._fillAnimations(this.animations["in"]), this._fillAnimations(this.animations.loop), this._fillAnimations(this.animations.out));
        var a = this.linearMode(i, s);
        return this.status = n.INITIALIZED, a
    }, i.prototype.setEventBased = function(e, i, s) {
        this.slide = e, this.timelineMode = "event";
        var r = !1,
            a = this.$layer.data("animations");
        1 == a || a && (r = t.parseJSON(N2Classes.Base64.decode(a))), "object" == typeof r ? (this.animations = t.extend({
            repeatable: 0,
            "in": [],
            specialZeroIn: 0,
            transformOriginIn: "50|*|50|*|0",
            ...
            outPlayEvent: "",
            instantOut: 1
        }, r), this.transformOriginIn = this.animations.transformOriginIn.split("|*|").join("% ") + "px", this.transformOriginOut = this.animations.transformOriginOut.split("|*|").join("% ") + "px") : this.animations = {
            repeatable: 0,
            "in": [],
            inPlayEvent: "",
            loop: [],
            ...
            "layerSetZero.n2-ss-animations": t.proxy(this.setZero, this),
            "layerSetZeroAll.n2-ss-animations": t.proxy(this.setZeroAll, this),
            "layerAnimationSetStart.n2-ss-animations": t.proxy(this.start, this),
            "layerPause.n2-ss-animations": t.proxy(this.pause, this),
            "layerReset.n2-ss-animations": t.proxy(this.reset, this),
            "beforeMainSwitch.n2-ss-animations": t.proxy(this.beforeMainSwitch, this)
        }), this.repeatable = this.animations.repeatable ? 1 : 0, this.repeatable && "" == this.animations.inPlayEvent && (this.animations.inPlayEvent = "layerAnimationPlayIn,OutComplete", "" == this.animations.loopPlayEvent && (this.animations.loopPlayEvent = "InComplete"), "" == this.animations.outPlayEvent && (this.animations.outPlayEvent = "LoopComplete")), this.animations.instantOut && (this.animations.outPlayEvent = "LoopComplete"), "" == this.animations.inPlayEvent && (this.animations.inPlayEvent = "layerAnimationPlayIn"), "" == this.animations.loopPlayEvent && (this.animations.loopPlayEvent = "InComplete"), this._fillAnimations(this.animations["in"]), this._fillAnimations(this.animations.loop), this._fillAnimations(this.animations.out), this.eventDrivenMode(i, s), this.status = n.INITIALIZED
        ...
        this.subscribeEvent("mainAnimationStartIn", t.proxy(this.resume, this)), this.inTimeline = new NextendTimeline({
            paused: 1,
            onComplete: t.proxy(this.inComplete, this)
        }), this.animations["in"] && this.animations["in"].length && this.buildTimelineIn(this.inTimeline, this.animations["in"], e, i, 0), this.$layer.triggerHandler("layerExtendTimelineIn", [this.inTimeline, 0]), this.inTimeline.totalDuration() ? (this.inTimeline.set(this.$animatableElement, {
            transformOrigin: this.transformOriginIn,
            immediateRender: !0
        }, 0), this.subscribeEvent(this.animations.inPlayEvent, t.proxy(this.playIn, this)), this.inStatus = r.INITIALIZED) : (this.subscribeEvent(this.animations.inPlayEvent, t.proxy(this.playIn, this)), this.inStatus = r.NO, this.inTimeline = null), this.animations.loop && 0 != this.animations.loop.length ? (this.loop = new s(this, this.$layer, this.$animatableElement, this.animations, e, i, this.timelineMode), this.subscribeEvent(this.animations.loopPlayEvent, t.proxy(this.playLoop, this)), this.loopStatus = a.INITIALIZED) : (this.loopStatus = a.NO, this.subscribeEvent("InComplete", t.proxy(this.loopComplete, this))), this.outTimeline = new NextendTimeline({
            paused: 1,
            onComplete: t.proxy(this.outComplete, this)
        }), this.animations.out && this.animations.out.length && this.buildTimelineOut(this.outTimeline, this.animations.out, e, i, 0), this.$layer.triggerHandler("layerExtendTimelineOut", [this.outTimeline, 0]), this.outTimeline.totalDuration() ? (this.outTimeline.set(this.$animatableElement, {
            transformOrigin: this.transformOriginOut
        }, 0), this.subscribeEvent(this.animations.outPlayEvent, t.proxy(this.playOut, this)), this.outStatus = o.INITIALIZED) : (this.subscribeEvent("LoopComplete", t.proxy(this.outComplete, this)), this.outStatus = o.NO, this.outTimeline = null), this.inStatus == r.NO && this.loopStatus == a.No && this.outStatus == o.NO && this.slide.$element.off("n2-ss-animations")
    }, i.prototype.linearMode = function(t, e) {
        if (this.$layer.triggerHandler("refreshTimeline"), this.animations) {
            this.linearTimeline = new NextendTimeline({
                paused: 1
            });
            var i = 0;
            return this.animations["in"] && 0 != this.animations["in"].length ? (this.linearTimeline.set(this.$animatableElement, {
                transformOrigin: this.transformOriginIn
            }), this.buildTimelineIn(this.linearTimeline, this.animations["in"], t, e, i), this.inStatus = r.INITIALIZED) : this.inStatus = r.NO, this.$layer.triggerHandler("layerExtendTimelineIn", [this.linearTimeline, i]), this.animations.loop && 0 != this.animations.loop.length ? new s(this, this.$layer, this.$animatableElement, this.animations, t, e, this.timelineMode) : this.loopStatus = a.NO, i = this.linearTimeline.totalDuration(), this.$layer.triggerHandler("layerExtendTimelineOut", [this.linearTimeline, i]), this.animations.out && 0 != this.animations.out.length ? (this.linearTimeline.set(this.$animatableElement, {
                transformOrigin: this.transformOriginOut
            }), this.buildTimelineOut(this.linearTimeline, this.animations.out, t, e, i), this.outStatus = o.INITIALIZED) : this.outStatus = o.NO, !0
        }
        var n = this.$layer.triggerHandler("needExtendTimelineIn"),
            l = this.$layer.triggerHandler("needExtendTimelineOut");
        if (n || l) {
            this.linearTimeline = new NextendTimeline({
                paused: 1
            });
            var i = 0;
            return n && (this.$layer.triggerHandler("layerExtendTimelineIn", [this.linearTimeline, i]), i = this.linearTimeline.totalDuration()), l && this.$layer.triggerHandler("layerExtendTimelineOut", [this.linearTimeline, i]), !0
        }
        return !1
    }, i.prototype.refresh = function(e, i) {
        this.reset(), this.setZero(), this.$layer.triggerHandler("refreshTimeline"), this.inTimeline = new NextendTimeline({
            paused: 1,
            onComplete: t.proxy(this.inComplete, this)
        }), this.animations["in"] && this.animations["in"].length && this.buildTimelineIn(this.inTimeline, this.animations["in"], e, i, 0), this.$layer.triggerHandler("layerExtendTimelineIn", [this.inTimeline, 0]), this.inTimeline.totalDuration() ? this.inStatus = r.INITIALIZED : this.inTimeline = null, this.animations.loop && 0 != this.animations.loop.length ? (this.loop.refresh(e, i), this.loopStatus = a.INITIALIZED) : this.loopStatus = a.NO, this.outTimeline = new NextendTimeline({
            paused: 1,
            onComplete: t.proxy(this.outComplete, this)
        }), this.animations.out && this.animations.out.length && this.buildTimelineOut(this.outTimeline, this.animations.out, e, i, 0), this.$layer.triggerHandler("layerExtendTimelineOut", [this.outTimeline, 0]), this.outTimeline.totalDuration() ? this.outStatus = o.INITIALIZED : (this.outStatus = o.NO, this.outTimeline = null)
    }, i.prototype.setZero = function() {
        NextendTween.set(this.$animatableElement, t.extend({
            clearProps: "transform,n2blur"
        }, l)), this.$layer.triggerHandler("AnimationSetZero")
    }, i.prototype.setZeroAll = function() {
        this.inStatus == r.INITIALIZED && this.inTimeline.progress(1), this.setZero()
            ...
            if (s[n].length) {
                ...
                switch (r[0]) {
                    ...
                    case "LayerMouseLeave":
                        a.match(/^Layer/) && (a = a.replace(/^Layer/, "").toLowerCase()), this.$layer.on(a, i);
                        break;
                    ...
                    case "SlideClick":
                        a.match(/^Slide/) && (a = a.replace(/^Slide/, "").toLowerCase()), this.slide.$element.on(a, i);
                        break;
                    case "SliderMouseEnter":
                    case "SliderMouseLeave":
                    case "SliderClick":
                        a.match(/^Slider/) && (a = a.replace(/^Slider/, "").toLowerCase()), this.slide.slider.sliderElement.on(a, t.proxy(function(e) {
                    ...
                    default:
                        ...
                        this.slide.$element.on(a, function() {
                            l["do"] && clearTimeout(l["do"]), l["do"] = setTimeout(function() {
                                o || i(), o = !1
                            }, 50)
                        }), this.slide.$element.on("cancel-" + a, function() {
                            o = !0, l.cancel && clearTimeout(l.cancel), l.cancel = setTimeout(function() {
                                o = !1
                            }, 70)
                        })
                }
            }
    }, i.prototype.loopEvents = function(e) {
        e ? ("" != this.animations.loopPauseEvent && this.subscribeEvent(this.animations.loopPauseEvent + ".n2-ss-loop", t.proxy(function() {
            this.loop && this.loop.pause()
        }, this)), "" != this.animations.loopStopEvent && this.subscribeEvent(this.animations.loopStopEvent + ".n2-ss-loop", t.proxy(function() {
            this.loop && this.loop.end()
        }, this))) : this.$layer.off(".n2-ss-loop")
    }, i.prototype.start = function() {
        this.outStatus != o.NO && (this.inStatus == r.NO && this.outTimeline.progress(.9999), this.outTimeline.pause(0, !1)), this.inStatus != r.NO && this.inTimeline.progress(.9999).pause(0, !1), this.status = n.INITIALIZED
    }, i.prototype.playIn = function() {
        this.status == n.INITIALIZED ? (this.status = n.PLAY_IN_STARTED, this.inStatus != r.NO ? 1 == this.inTimeline.progress() ? this.inTimeline.play(this.startDelay) : this.inTimeline.play() : this.inComplete()) : this.status == n.PLAY_IN_STARTED ? this.skipLoop && (this.skipLoop = 0, this.$layer.off("InComplete.n2-instant-out")) : this.status == n.PLAY_OUT_STARTED ? (this.$layer.one("OutComplete.n2-instant-in", t.proxy(function() {
            this.playIn()
        }, this)), this.outTimeline.totalDuration(.3)) : this.status == n.PLAY_LOOP_STARTED ? (this.$layer.one("OutComplete.n2-instant-in", t.proxy(function() {
            this.playIn()
        }, this)), this.outTimeline.totalDuration(.3)) : this.status == n.PLAY_LOOP_ENDED && (this.$layer.one("OutComplete.n2-instant-in", t.proxy(function() {
            this.playIn()
        }, this)), this.outTimeline.totalDuration(.3))
    }, i.prototype.inComplete = function() {
        this.inPlayed = 1, this.status = n.PLAY_IN_ENDED, this.$layer.triggerHandler("InComplete")
    }, i.prototype.playLoop = function() {
        this.status != n.PLAY_IN_ENDED || this.skipLoop ? this.status == n.PLAY_LOOP_STARTED && this.loop.playIn() : (this.status = n.PLAY_LOOP_STARTED, this.loopStatus != a.NO ? (this.$layer.off(".FrontendLayerAnimations").on("_LoopComplete.FrontendLayerAnimations", t.proxy(this.loopComplete, this)), this.loop.playIn()) : this.loopComplete())
    }, i.prototype.loopComplete = function() {
        1 != this.animations.loopRepeatSelfOnly || this.skipLoop ? (this.status = n.PLAY_LOOP_ENDED, this.$layer.triggerHandler("LoopComplete")) : this.status = n.PLAY_IN_ENDED
    }, i.prototype.playOut = function() {
        this.status == n.PLAY_IN_STARTED ? this.skipLoop || (this.skipLoop = 1, this.$layer.one("InComplete.n2-instant-out", t.proxy(function() {
            this.skipLoop = 0, this.loopComplete(), this._playOut()
        }, this))) : this.status == n.PLAY_IN_ENDED ? (this.loopComplete(), this._playOut()) : this.status == n.PLAY_LOOP_STARTED ? (this.$layer.off("OutComplete.n2-instant-in"), this.$layer.one("LoopComplete", t.proxy(this._playOut, this)), this.loop.end()) : this.status == n.PLAY_LOOP_ENDED ? (this.$layer.off("OutComplete.n2-instant-in"), this._playOut()) : this.status == n.PLAY_OUT_STARTED ? this.$layer.off("OutComplete.n2-instant-in") : this.$layer.off("OutComplete.n2-instant-in")
    }, i.prototype._playOut = function() {
        this.status == n.PLAY_LOOP_ENDED && (this.status = n.PLAY_OUT_STARTED, this.outStatus != o.NO ? 1 == this.outTimeline.progress() ? (this.outTimeline.timeScale(1), this.outTimeline.play(0)) : this.outTimeline.play() : this.outComplete())
    }, i.prototype.outComplete = function() {
        !this.repeatable || this.inStatus == r.NO && this.loopStatus == a.NO && this.outStatus == r.NO ? this.status = n.PLAY_OUT_ENDED : (this.status = n.INITIALIZED, NextendTween.set(this.$animatableElement, {
            transformOrigin: this.transformOriginIn
        }), this.loopStatus != a.NO && this.loop.replay()), this.$layer.triggerHandler("OutComplete")
    }, i.prototype.beforeMainSwitch = function(t, e) {
        this.status == n.INITIALIZED && (this.status = n.PLAY_IN_DISABLED), e.push(this.end())
    }, i.prototype.end = function() {
        if (this.status > n.PLAY_IN_DISABLED && this.status < n.PLAY_OUT_ENDED) {
            var e = t.Deferred();
            return this.$layer.one("OutComplete", t.proxy(function() {
                this.status = n.PLAY_IN_DISABLED, e.resolve()
            }, this)), this.playOut(), e
        }
        return !0
    }, i.prototype.reset = function() {
        switch (this.status) {
            case n.PLAY_OUT_STARTED:
                this.outTimeline.pause(0);
                break;
            case n.PLAY_LOOP_STARTED:
                this.loop.reset();
                break;
            case n.PLAY_IN_STARTED:
                this.inTimeline.pause(0)
        }
        this.status = n.INITIALIZED
    }, i.prototype.pause = function() {
        switch (this.paused = !0, this.status) {
            case n.INITIALIZED:
                this.status = n.PLAY_IN_DISABLED;
                break;
            case n.PLAY_IN_STARTED:
                this.status = n.PLAY_IN_PAUSED, this.inTimeline.pause();
                break;
            case n.PLAY_LOOP_STARTED:
                this.status = n.PLAY_LOOP_PAUSED, this.loop.pause();
                break;
            case n.PLAY_OUT_STARTED:
                this.status = n.PLAY_OUT_PAUSED, this.outTimeline.pause()
        }
    }, i.prototype.resume = function() {
        this.status == n.PLAY_IN_DISABLED ? this.status = n.INITIALIZED : this.status == n.PLAY_IN_PAUSED ? (this.status = n.PLAY_IN_STARTED, this.inTimeline.play()) : this.status == n.PLAY_LOOP_PAUSED ? (this.status = n.PLAY_LOOP_STARTED, this.loop.play()) : this.status == n.PLAY_OUT_PAUSED && (this.status = n.PLAY_OUT_STARTED, this.outTimeline.play())
        ...
        if (i = t.extend(!0, [], i), this.animations.specialZeroIn && i.length > 0 && (this.currentZero = i.pop(), delete this.currentZero.name, delete this.currentZero.duration, delete this.currentZero.delay, delete this.currentZero.ease, this.currentZero.x = this.currentZero.x * s, this.currentZero.y = this.currentZero.y * n, this.currentZero.rotationX = -this.currentZero.rotationX, this.currentZero.rotationY = -this.currentZero.rotationY, this.currentZero.rotationZ = -this.currentZero.rotationZ, this.setCurrentZero()), i.length > 0) {
            var a = this._buildAnimationChainIn(i, s, n, this.currentZero);
            if (a.length > 0) {
                var o = 0;
                for (this.startDelay = a[o].to.delay, c(e, this.$animatableElement, a[o].duration, a[o].from, a[o].to, 0, r), r += a[o].duration + a[o].to.delay, o++; o < a.length; o++) p(e, this.$animatableElement, a[o].duration, a[o].to, r), r += a[o].duration + a[o].to.delay
            }
        }
    }, i.prototype._buildAnimationChainIn = function(e, i, s, n) {
        for (var r = [{
                from: n
            }], a = e.length - 1; a >= 0; a--) {
            var o = t.extend(!0, {}, e[a]),
                l = o.delay,
                h = o.duration,
                d = o.ease;
            delete o.delay, delete o.duration, delete o.ease, delete o.name;
            var p = r[0].from;
            o.x = -o.x * i, o.y = -o.y * s, o.z = -o.z, o.rotationX = -o.rotationX, o.rotationY = -o.rotationY, o.rotationZ = -o.rotationZ, r.unshift({
                duration: h,
                from: o,
                to: t.extend({}, p, {
                    ease: d,
        ...
        i = t.extend(!0, [], i);
        var a = this._buildAnimationChainOut(i, s, n),
            o = 0;
        if (a.length > 0)
            for (0 != r ? p(e, this.$animatableElement, a[o].duration, a[o].to, r) : c(e, this.$animatableElement, a[o].duration, a[o].from, a[o].to, r), r += a[o].duration + a[o].to.delay, o++; o < a.length; o++) p(e, this.$animatableElement, a[o].duration, a[o].to, r), r += a[o].duration + a[o].to.delay
    }, i.prototype._buildAnimationChainOut = function(e, i, s) {
        for (var n = [{
                to: this.currentZero
            }], r = 0; r < e.length; r++) {
            var a = t.extend(!0, {}, e[r]),
                o = a.duration;
            delete a.duration, delete a.name;
            var l = t.extend({
                immediateRender: !1
            }, n[n.length - 1].to);
            delete l.delay, delete l.ease, a.x = a.x * i, a.y = a.y * s, n.push({
                duration: o,
                from: l,
                to: a
            })
    ...
    return s.prototype.refresh = function(e, i) {
        this.timeline = new NextendTimeline({
            paused: !0
        }), this.buildTimelineLoop(t.extend(!0, [], this.animations.loop), e, i), this.status = u.INITIALIZED
    }, s.prototype.playIn = function() {
        if (this.status == u.INITIALIZED || this.status == u.PLAY_OUT_ENDED)
            if (NextendTween.set(this.$animatableElement, {
                    transformOrigin: this.transformOrigin
                }), this.single) this.status = u.PLAY_IN_ENDED, this.timeline.delay(this.repeatStartDelay), this.playLoop();
            else {
                this.status = u.PLAY_IN_STARTED;
                var e = t.extend({}, this.zero.from);
                e.delay = this.repeatStartDelay, e.onComplete = t.proxy(function() {
                    this.status = u.PLAY_IN_ENDED, this.playLoop()
                }, this), this.inAnimation = d(this.$animatableElement, this.zero.duration / 2, e)
            }
        else this.play()
    }, s.prototype.playLoop = function() {
        this.status == u.PLAY_IN_ENDED && (this.status = u.PLAY_LOOP_STARTED, this._counter = 0, this.layers.loopEvents(1), this.timeline.eventCallback("onComplete", t.proxy(function() {
            this._counter++, this.repeatTimeline() || (this.status = u.PLAY_LOOP_ENDED, this.playOut())
        }, this)), this.timeline.restart(!0))
    }, s.prototype.playOut = function() {
        if (this.status == u.PLAY_LOOP_ENDED)
            if (this.single) this.status = u.PLAY_OUT_ENDED, this.$layer.triggerHandler("_LoopComplete");
            else {
                this.status = u.PLAY_OUT_STARTED;
                var e = t.extend({}, this.layers.currentZero);
                e.onComplete = t.proxy(function() {
                    this.status = u.PLAY_OUT_ENDED, this.$layer.triggerHandler("_LoopComplete")
                }, this), this.outAnimation = d(this.$animatableElement, this.zero.duration / 2, e)
            }
    }, s.prototype.repeatTimeline = function() {
        return 0 == this.repeatCount || this._counter < this.repeatCount ? (this.timeline.restart(), this.$layer.triggerHandler("LoopRoundComplete"), !0) : !1
    }, s.prototype.pause = function() {
        this.status == u.PLAY_IN_STARTED ? (this.status = u.PLAY_IN_PAUSED, this.inAnimation.pause()) : this.status == u.PLAY_LOOP_STARTED ? (this.status = u.PLAY_LOOP_PAUSED, this.timeline.pause()) : this.status == u.PLAY_OUT_STARTED && (this.status = u.PLAY_OUT_PAUSED, this.outAnimation.pause())
    }, s.prototype.play = function() {
        this.status == u.PLAY_IN_PAUSED ? (this.status = u.PLAY_IN_STARTED, this.inAnimation.play()) : this.status == u.PLAY_LOOP_PAUSED ? (this.status = u.PLAY_LOOP_STARTED, this.timeline.play()) : this.status == u.PLAY_OUT_PAUSED && (this.status = u.PLAY_OUT_STARTED, this.outAnimation.play())
    }, s.prototype.reset = function() {
        this.outAnimation && this.outAnimation.pause(0), this.timeline.pause(0), this.inAnimation && this.inAnimation.pause(0), this.status = u.INITIALIZED
    }, s.prototype.end = function() {
        var e = t.Deferred();
        if (this.status == u.PLAY_OUT_ENDED) return this.status = u.INITIALIZED, e.resolve(), e;
        switch (this.$layer.one("_LoopComplete", t.proxy(function() {
            this.status = u.INITIALIZED, e.resolve()
        }, this)), this.timeline.eventCallback("onComplete", t.proxy(function() {
            this._counter++, 0 != this.repeatCount && this.repeatTimeline() || (this.status = u.PLAY_LOOP_ENDED, this.playOut())
        }, this)), this.status) {
            case u.PLAY_OUT_PAUSED:
                this.outAnimation.play();
                break;
            case u.PLAY_IN_PAUSED:
                this.inAnimation.play();
                break;
            case u.PLAY_LOOP_PAUSED:
                this.timeline.play()
        }
        return e
    }, s.prototype.buildTimelineLoop = function(e, i, s) {
        var n = this._buildAnimationChainLoop(e, i, s);
        if (this.zero = t.extend(!0, {}, n[0]), "linear" == this.timelineMode) {
            if (this.timeline.delay(this.repeatStartDelay), this.timeline.set(this.$animatableElement, {
                    transformOrigin: this.transformOrigin
                }), !this.single) {
                var r = t.extend({}, this.zero.from);
                p(this.timeline, this.$animatableElement, this.zero.duration / 2, r)
            }
            var a = this.repeatCount;
            1 > a && (a = 1);
            for (var o = 0; a > o; o++)
                for (var l = 0; l < n.length; l++) c(this.timeline, this.$animatableElement, n[l].duration, t.extend({
                    immediateRender: !1
                }, n[l].from), t.extend({}, n[l].to));
            this.single || p(this.timeline, this.$animatableElement, this.zero.duration / 2, t.extend({}, this.layers.currentZero)), this.layers.linearTimeline.add(this.timeline), this.timeline.paused(!1)
        } else
            for (var l = 0; l < n.length; l++) p(this.timeline, this.$animatableElement, n[l].duration, n[l].to)
    }, s.prototype._buildAnimationChainLoop = function(e, i, s) {
        if (1 == e.length) {
            this.single = !0;
            var n = t.extend(!0, {}, e[0]),
                r = t.extend({}, this.layers.currentZero);
        ...
        var a = 0;
        delete e[a].name, e[a].x = e[a].x * i, e[a].y = e[a].y * s;
        var o = [{
            duration: e[a].duration,
            from: t.extend({}, this.layers.currentZero),
            to: e[a]
        }];
        for (a++; a < e.length; a++) {
            var r = e[a],
            ...
            var h = t.extend({}, o[o.length - 1].to);
            delete h.delay, delete h.ease, r.x = r.x * i, r.y = r.y * s, o.push({
                duration: l,
                from: h,
                to: r
            })
        }
        return this.single || (o.push({
            duration: o[0].duration,
            from: t.extend({}, o[o.length - 1].to),
            to: t.extend({}, o[0].to)
        }), o.shift(), delete o[0].from.duration), o
    }, s.prototype.replay = function() {
        this.status = u.INITIALIZED, this._counter = 0
    }, i
    ...
    function i(e, i, s) {
        ...
        this.manager = s, this.loadDeferred = t.Deferred(), this.elements = {
            ...
            image: !1,
            video: !1
        }, this.currentSrc = "", this.mode = i.data("mode"), "fixed" === this.mode && (n2const.isPhone && !e.slider.parameters["background.parallax.mobile"] || n2const.isTablet && !e.slider.parameters["background.parallax.tablet"]) && (this.mode = "fill"), this.opacity = i.data("opacity"), this.$image = this.element.find("img"), this.$image.length && (this.elements.image = new N2Classes[this.types.image](e, s, this, this.$image));
        var r = this.element.find(".n2-ss-slide-background-color");
        r.length && (this.elements.color = new N2Classes[this.types.color](this, r));
        var a = this.element.find(".n2-ss-slide-background-video");
        a.length && (this.elements.video = new N2Classes[this.types.video](this.slide, this, a));
        var o = [];
        for (var l in this.elements) this.elements[l] && o.push(this.elements[l].getLoadedDeferred());
        t.when.apply(t, o).then(t.proxy(function() {
    ...
    function i(t, e, i, s) {
        ...
        if (this.animations = i.data("animations"), this.parallax = i.data("parallax"), this.baseSize = this.baseSize || 100, this.isAdaptiveFont = this.get("adaptivefont"), this.refreshBaseSize(this.getDevice("fontsize")), s)
            for (var a = 0; a < s.length; a++) switch (s.eq(a).data("sstype")) {
                case "content":
                    this.children.push(new N2Classes.FrontendComponentContent(this.slide, this, s.eq(a)));
                    break;
                case "row":
                    this.children.push(new N2Classes.FrontendComponentRow(this.slide, this, s.eq(a)));
                    break;
                case "col":
                    this.children.push(new N2Classes.FrontendComponentCol(this.slide, this, s.eq(a)));
                    break;
                case "group":
                    this.children.push(new N2Classes.FrontendComponentGroup(this.slide, this, s.eq(a)));
                    break;
                default:
                    this.children.push(new N2Classes.FrontendComponentLayer(this.slide, this, s.eq(a)))
            }
    }
    return i.prototype.refreshBaseSize = function(t) {
        ...
        var i = [];
        if (this.isVisible) {
            if (this.animations || this.$layer.triggerHandler("needExtendTimelineIn") || this.$layer.triggerHandler("needExtendTimelineOut")) {
                this.$layer.triggerHandler("refreshTimeline");
                var s = this.$layer,
                    n = s.data("animatableselector");
                n && (s = s.find(n));
                var r = new N2Classes.FrontendLayerAnimations(this.$layer, s, this.slide.getPerspective());
                r.setEventBased(this.slide, t, e), i.push(r)
            }
            for (var a = 0; a < this.children.length; a++) i.push.apply(i, this.children[a].createLayerAnimations(t, e))
        }
        return i
    ...
    var i = {
        ...
        elements: [],
        start: function() {
            this.isStarted || (this.$window = t(window), this.resize(), this.$window.on({
                "load.n2-ss-bg-parallax": t.proxy(this.resize, this),
                "resize.n2-ss-bg-parallax": t.proxy(this.resize, this),
                "scroll.n2-ss-bg-parallax": t.proxy(this.resize, this)
            }).on({
                "scroll.n2-ss-bg-parallax": t.proxy(this.render, this),
                "resize.n2-ss-bg-parallax": t.proxy(this.render, this)
            }), this.isStarted = !0)
        },
        end: function() {
            this.isStarted && (this.$window.off(".n2-ss-bg-parallax"), this.isStarted = !1)
        },
        addElement: function(t, e) {
            ...
            }), this.start(), this._resizeElement(this.elements[this.elements.length - 1])
        },
        removeElement: function(t) {
            for (var e = 0; e < this.elements.length; e++)
                if (this.elements[e].$element === t) {
        ...
        resize: function() {
            this._windowHeight = 200 + (window.n2ClientHeight || document.documentElement.clientHeight || document.body.clientHeight);
            for (var t = 0; t < this.elements.length; t++) this._resizeElement(this.elements[t])
        },
        _resizeElement: function(t) {
            var e = t.$parent;
            t.offsetTop = e.offset().top, NextendTween.set(t.$element, {
                marginTop: -100,
                height: this._windowHeight
            })
        },
        render: function() {
            for (var t = this.$window.scrollTop(), e = 0; e < this.elements.length; e++) NextendTween.to(this.elements[e].$element, .4, {
                y: t - this.elements[e].offsetTop
            })
        }
    };
    return i
    ...
    return i.prototype.resize = function() {
        ...
        null !== this.parallaxedSlideNodes && this.end(), this.firstStart && (this.slider.staticSlide && (this.parallaxedStaticSlideNodes = this.slider.staticSlide.getParallaxNodes()), this.firstStart = !1), this.parallaxedSlideNodes = e.getParallaxNodes(), this.parallaxedNodes = t.merge(t.merge([], this.parallaxedSlideNodes), this.parallaxedStaticSlideNodes), this.parallaxedNodes.length ? (this.active || this.enable(), this._scrollCallback && this._scrollCallback()) : (this.parallaxedNodes = null, this.parallaxedSlideNodes = null, this.active && this.disable())
    }, i.prototype.end = function() {
        ...
        if (this.parallaxedNodes)
            for (var s = 0; s < this.parallaxedNodes.length; s++) {
                ...
                if (this.parameters.is3D) {
                    var o = this.levelsDeg[n];
                    a.rotationX = this.rotationX * o, a.rotationY = this.rotationY * o
                }
                a.x = this.x * r, a.y = this.y * r, this.render(this.parallaxedNodes[s], a)
            }
    ...
    return i.prototype = Object.create(N2Classes.FrontendComponent.prototype), i.prototype.constructor = i, i.prototype.is = function(t) {
        ...
        this.slider.isAdmin || this.slider.visible(t.proxy(function() {
            this.slider.parameters.layerMode.playFirstLayer ? (this.setStart(), this.playIn()) : this.setZeroAll()
        }, this))
        ...
        for (var e = 0; e < this.layerAnimations.length; e++) this.layerAnimations[e].refresh(t.slideW, t.slideH)
    ...
    function i(e, i, s, n) {
        if (this.loadStarted = !1, this.loadAllowed = !1, this.slide = e, this.manager = i, this.background = s, this.deferred = t.Deferred(), this.$el = n, this.opacity = n.data("opacity"), this.blur = n.data("blur"), this.x = n.data("x"), this.y = n.data("y"), n.css("display", "none"), this.$background = t('<div class="n2-ss-slide-background-image"/>').css({
            ...
            }).insertAfter(n), "blurfit" === s.mode && (this.$background = this.$background.add(this.$background.clone().insertAfter(this.$background)), this.$background.first().css({
                margin: "-14px",
                padding: "14px"
            }).css(window.n2FilterProperty, "blur(7px)")), window.n2FilterProperty && (this.blur > 0 ? this.$background.last().css({
                margin: "-" + 2 * this.blur + "px",
                padding: 2 * this.blur + "px"
            }).css(window.n2FilterProperty, "blur(" + this.blur + "px)") : this.$background.last().css({
                margin: "",
                padding: ""
            }).css(window.n2FilterProperty, "")), "fixed" === s.mode && this.startFixed(), this.desktopSrc = n.data("desktop") || "", this.tabletSrc = n.data("tablet") || "", this.mobileSrc = n.data("mobile") || "", n2const.isRetina) {
            var r = n.data("desktop-retina");
            r && (this.desktopSrc = r), r = n.data("tablet-retina"), r && (this.tabletSrc = r), r = n.data("mobile-retina"), r && (this.mobileSrc = r)
        }
    }
    return i.prototype.getLoadedDeferred = function() {
        ...
        this.loadAllowed = !0, this.manager.deviceDeferred.done(t.proxy(function() {
            this.updateBackgroundToDevice(this.manager.device), this.$background.n2imagesLoaded({
                ...
                this.width = e.naturalWidth, this.height = e.naturalHeight, this.deferred.resolve()
            }, this))
        }, this))
    }, i.prototype.updateBackgroundToDevice = function(t) {
        var e = this.desktopSrc;
        "mobile" === t.device ? this.mobileSrc ? e = this.mobileSrc : this.tabletSrc && (e = this.tabletSrc) : "tablet" === t.device && this.tabletSrc && (e = this.tabletSrc), e ? this.setSrc(e) : this.setSrc("")
    ...
    }, i.prototype.startFixed = function() {
        n2const.isEdge || (this.slide.slider.parameters.allowBGImageAttachmentFixed && !n2const.isIOS ? this.$background.css({
            backgroundRepeat: "repeat",
            position: "relative",
            backgroundAttachment: "fixed"
        }) : n2const.isIE || this.slide.slider.startedDeferred.done(t.proxy(function() {
    ...
    function i(e, i, r) {
        !e.slider.parameters["background.video.mobile"] && n2const.isPhone ? r.remove() : s ? (this.counter = n++, this.slide = e, this.slider = e.slider, this.background = i, this.isResized = !1, this.$video = r, this.isReady = !1, this.state = {
            ready: !1,
            scroll: !1,
            slide: !1
        }, this.promise = !1, i.elements.image ? this.slider.visible(t.proxy(this.load, this)) : this.load()) : r.remove()
    }
    var s = !/Mobi/.test(navigator.userAgent) || "playsInline" in document.createElement("video") || "webkit-playsinline" in document.createElement("video") || navigator.userAgent.match(/Chrom(e|ium)\/([0-9]+)\./) && parseInt(navigator.userAgent.match(/Chrom(e|ium)\/([0-9]+)\./)[2]) >= 53,
        n = 1;
    return i.prototype.load = function() {
        if (this.$video[0].videoWidth > 0) this.onReady();
        else {
            this.$video[0].addEventListener("error", t.proxy(this.onError, this), !0), this.$video[0].addEventListener("canplay", t.proxy(this.onReady, this)), this.$video[0].addEventListener("loadedmetadata", t.proxy(this.onReady, this), !1);
        ...
        if (!this.isReady) {
            ...
            }), N2Classes.ScrollTracker.add(this.slide.$element, "instant", t.proxy(function() {
                this.setState("scroll", !0, !0)
            }, this), t.proxy(function() {
                this.setState("scroll", !1, !0)
            }, this))
        }
        "canplay" === e.type && this.background.fadeOut()
        ...
        i = i || !1, this.state[t] = e, i && (this.state.ready && this.state.slide && this.state.scroll ? (this.safePlay(), this.$video.triggerHandler("n2playvideo")) : this.safePause())
    }, i
    ...
    return /(MSIE\ [0-7]\.\d+)/.test(navigator.userAgent), s.prototype = Object.create(N2Classes.FrontendPlacement.prototype), s.prototype.constructor = s, s.prototype.start = function() {
        ...
        var n = this.layer.$layer,
            ...
            o = t.slideH,
            l = o;
        parseInt(this.layer.get("responsivesize")) || (a = l = 1), n.css("width", this.getWidth(a)), n.css("height", this.getHeight(l)), parseInt(this.layer.get("responsiveposition")) || (r = o = 1);
        var h = this.layer.getDevice("left") * r,
            d = this.layer.getDevice("top") * o,
        ...
        if (this.$parent && this.$parent.data("layer").isVisible) {
            ...
            switch (this.layer.getDevice("parentalign")) {
                case "right":
                    y.left = m.left + this.$parent.width();
                    break;
                case "center":
                    y.left = m.left + this.$parent.width() / 2;
                    break;
                default:
                    y.left = m.left
            }
            switch (p) {
                case "right":
                    u.right = n.parent().width() - y.left - h + "px";
                    break;
                case "center":
                    u.left = y.left + h - n.width() / 2 + "px";
                    break;
                default:
                    u.left = y.left + h + "px"
            }
            switch (this.layer.getDevice("parentvalign")) {
                case "bottom":
                    y.top = m.top + this.$parent.height();
                    break;
                case "middle":
                    y.top = m.top + this.$parent.height() / 2;
                    break;
                default:
                    y.top = m.top
            }
            switch (c) {
                case "bottom":
                    u.bottom = n.parent().height() - y.top - d + "px";
                    break;
                case "middle":
                    u.top = y.top + d - n.height() / 2 + "px";
                    break;
                default:
                    u.top = y.top + d + "px"
            }
        ...
        n.css(u);
        for (var f = 0; f < this.linked.length; f++) this.linked[f].onResizeLinked(t, e, s)
    ...
    return i.prototype = Object.create(N2Classes.FrontendComponent.prototype), i.prototype.constructor = i, i.prototype.onDeviceChange = function(t) {
        ...
        if (s) {
            ...
            for (n = 0; i > n; n++) {
                ...
                "undefined" == typeof r[a] && (r[a] = []), r[a].push(e[n]), e[n].$layer.attr("data-r", a).toggleClass("n2-ss-last-in-row", (n + 1) % t === 0 || n === i - 1)
            }
            var o = this.getDevice("gutter");
            for (n = 0; n < r.length; n++) {
                var l, h = r[n],
                    d = 0;
                for (l = 0; l < h.length; l++) d += h[l].getWidthPercentage();
                for (l = 0; l < h.length; l++) h[l].$layer.css("width", "calc(" + h[l].getWidthPercentage() / d * 100 + "% - " + o + "px)")
            }
        } else {
            var d = 0;
    ...
    function i(e, i) {
        this.disableTransitions = !1, this.disableTransitionsTimeout = null, this.lastClientHeight = 0, this.lastOrientation = 0, this.invalidateResponsiveState = !0, this.parameters = t.extend({
            desktop: 1,
            tablet: 1,
            mobile: 1,
            onResizeEnabled: !0,
    ...
    return i.OrientationMode = {
        ...
        switch (this.sliderElement.triggerHandler("SliderResponsiveStarted"), this.sliderElement.one("SliderResize", function() {
            ...
            default:
                if (null == s) {
                    var a = new MobileDetect(window.navigator.userAgent, 801);
                    s = !!a.tablet(), n = !!a.phone()
                }
        }
        if (this.verticalOffsetSelectors = t(this.parameters.verticalOffsetSelectors), this.storeDefaults(), this.parameters.minimumHeight > 0 && (this.parameters.minimumHeightRatio = this.parameters.minimumHeight / this.responsiveDimensions.startHeight), this.parameters.maximumHeight > 0 && this.parameters.maximumHeight >= this.parameters.minimumHeight && (this.parameters.maximumHeightRatio = {
            ...
            for (var o in this.parameters.maximumHeightRatio) this.parameters.maximumHeightRatio[o] *= this.parameters.verticalRatioModifiers[o]
        }
        if (N2Classes.Zoom !== e && N2Classes.Zoom.add(this), this.onResize(), (this.parameters.onResizeEnabled || "adaptive" == this.parameters.type) && (t(window).on({
                resize: t.proxy(this.onResize, this),
                orientationchange: t.proxy(this.onResize, this)
            }), this.sliderElement.on("SliderInternalResize", t.proxy(this.onResize, this)), this.parameters.scrollFix)) try {
            var l = this;
            t('<iframe sandbox="allow-same-origin allow-scripts" style="height: 0; background-color: transparent; margin: 0; padding: 0; overflow: hidden; border-width: 0; position: absolute; width: 100%;"/>').on("load", function(e) {
                t(e.target.contentWindow ? e.target.contentWindow : e.target.contentDocument.defaultView).on("resize", function() {
                    l.sliderElement.triggerHandler("SliderInternalResize")
                })
        ...
        this.slider.mainAnimation && "playing" == this.slider.mainAnimation.getState() ? this.delayedResizeAdded || (this.delayedResizeAdded = !0, this.sliderElement.on("mainAnimationComplete.responsive", t.proxy(this._doDelayedResize, this))) : this.doResize(e)
    }, i.prototype._doDelayedResize = function() {
        this.doResize(), this.delayedResizeAdded = !1
        ...
        var a;
        if ("center" === this.slider.parameters.align && ("fullpage" === this.parameters.type ? this.alignElement.css("maxWidth", "none") : (a = this.responsiveDimensions.startWidth, this.staticSizes && (a += this.staticSizes.paddingLeft + this.staticSizes.paddingRight), this.alignElement.css("maxWidth", a))), !this.slider.isAdmin && this.parameters.forceFull) {
            ...
            if ("" !== this.parameters.forceFullHorizontalSelector) {
                ...
                h && h.length > 0 && (o = h.width(), l = h.offset().left)
            }
            var d, p = o > 0 ? o : document.body.clientWidth || document.documentElement.clientWidth,
        ...
        if (this.orientation !== v && (this.orientation = v, y = !0, this.sliderElement.trigger("SliderOrientation", {
                lastOrientation: i._DeviceOrientation[f],
            ...
            }), y = !0), !this.slider.isAdmin && "fullpage" === this.parameters.type) {
            var b = 0;
            ...
            this.parameters.maximumHeightRatio[this.getDeviceModeOrientation()] = this.parameters.minimumHeightRatio = (b - this.getVerticalOffsetHeight()) / this.responsiveDimensions.startHeight
        }
        if (y) {
            var A = this._normalizeMode(i._DeviceMode[g], i._DeviceOrientation[f]),
                T = this._normalizeMode(i._DeviceMode[this.deviceMode], i._DeviceOrientation[this.orientation]);
            A[0] === T[0] && A[1] === T[1] || (this.normalizedMode = T[0] + T[1], this.sliderElement.trigger("SliderDeviceOrientation", {
                lastDevice: A[0],
                lastOrientation: A[1],
                device: T[0],
                orientation: T[1]
        ...
        var D = this.parameters.sliderWidthToDevice[this.normalizedMode] / this.parameters.sliderWidthToDevice.desktopPortrait;
        !this.parameters.downscale && D > m ? m = D : !this.parameters.upscale && m > D && (m = D), this._doResize(m, s, n, r), "center" === this.slider.parameters.align && (a = this.responsiveDimensions.slider.width, this.staticSizes && (a += this.staticSizes.paddingLeft + this.staticSizes.paddingRight), this.responsiveDimensions && (a += this.responsiveDimensions.startSliderMarginhorizontal), this.alignElement.css("maxWidth", a))
        ...
        var a = !1;
        for (var o in r)
            if (r[o] != this.lastRawRatios[o]) {
                a = !0;
                break
            }(this.invalidateResponsiveState || a) && (this.lastRawRatios = t.extend({}, r), this.resizeHorizontalElements(r), this.finishResize(r, i, n))
        ...
        if (t.slideH *= r, "fullpage" === this.parameters.type) t.h *= r, this.parameters.minimumHeightRatio > 0 && (t.h = Math.max(t.h, this.parameters.minimumHeightRatio)), this.parameters.maximumHeightRatio[n] > 0 && (t.h = Math.min(t.h, this.parameters.maximumHeightRatio[n])), this.slider.isAdmin ? this.parameters.constrainRatio ? (t.slideH = Math.min(t.slideH, t.h), t.slideH = t.slideW = Math.min(t.slideW, t.slideH)) : (t.w = t.slideW, t.h = t.slideH) : this.parameters.constrainRatio ? (t.slideH = Math.min(t.slideH, t.h), t.slideH = t.slideW = Math.min(t.slideW, t.slideH)) : (t.slideW = t.w, this.parameters.maximumSlideWidthRatio[n] > 0 && t.slideW > this.parameters.maximumSlideWidthRatio[n] && (t.slideW = this.parameters.maximumSlideWidthRatio[n]), t.slideH = t.h);
            ...
            var a;
            if (s !== e && s.background.elements.image !== e ? a = s.background.elements.image : this.slider.currentSlide.background.elements.image !== e && (a = this.slider.currentSlide.background.elements.image), a !== e && a.width > 0 && a.height > 0) {
                var o = this.responsiveDimensions.startSlideWidth / a.width * (a.height / this.responsiveDimensions.startSlideHeight);
                o > 0 && (t.slideH *= o, t.h *= o)
            }
        }
        ...
        this.widgetMargins[t].push(e), e.isVisible() && (this._addMarginSize(t, e.getSize()), this.enabledWidgetMargins.push(e)), this.doNormalizedResize()
    ...
    return i.prototype._lateInit = function(e) {
        ...
        for (var r in this.data) {
            var a = this.data[r] * e;
            "function" == typeof this[r + "Prepare"] && (a = this[r + "Prepare"](a)), this.name && (t[this.name][r] = a), n[r] = a
        }
        if (i) i.to(this.element, s, n, 0);
        else if (this.element.css(n), this.helper.centered) {
            var o = this.getVerticalMargin(parseInt((this.helper.parent.height() - this.element.height()) / 2)),
    ...
    return i.prototype.initAutoplay = function() {
        this.isStatic ? this.audio.play() : (this.slider.sliderElement.on("mainAnimationComplete", t.proxy(function(e, i, s, n, r) {
            t.inArray(this.slide, this.slider.getVisibleSlides(this.slider.slides[n])) >= 0 && this.audio.play()
        }, this)), t.inArray(this.slide, this.slider.getVisibleSlides()) >= 0 && this.audio.play())
        ...
        this.$time = this.$node.find(".n2-ss-item-audio-time"), this.updateTime(), this.audio.volume = this.parameters.volume, this.$node.find(".n2-ss-item-audio-play").on("click", t.proxy(function() {
            ...
            s != this.slideIndex && this.audio.pause()
        ...
        1 == this.parameters.loop ? (this.audio.currentTime = 0, this.audio.play()) : (this.isStatic || this.slider.sliderElement.trigger("mediaEnded", this.id), this.$layer.triggerHandler("n2stop"))
    ...
    function i(e, i, s) {
        this.slider = e, this.id = i, this.data = s, this.currentPercent = 0, this.node = t("#" + i).data("counter", this), this.data.displayMode && (this.$display = this.node.find(s.display)), this.$countingDiv = this.node.find(s.counting), this.layer = this.node.closest(".n2-ss-layer").on("needExtendTimelineIn." + i, t.proxy(this.needExtendTimelineIn, this)).on("layerExtendTimelineIn." + i, t.proxy(this.extendTimelineIn, this))
    }
    return i.prototype.needExtendTimelineIn = function() {
        return !0
    ...
    }, i.prototype.extendTimelineIn = function(t, e, i) {
        var s = {
            percent: this.data.fromPercent
        };
        this.currentPercent = this.data.fromPercent, e.to(s, this.data.duration / 1e3, this._animateData(s, this.data.toPercent), i + this.data.delay / 1e3)
    }, i.prototype.to = function(t, e) {
        var i = {
            percent: this.currentPercent
        };
        NextendTween.to(i, this.data.duration / 1e3, this._animateData(i, t, e))
    }, i.prototype.fromTo = function(t, e, i) {
        var s = {
            percent: t
        };
        NextendTween.to(s, this.data.duration / 1e3, this._animateData(s, e, i))
    }, i
}), N2D("FrontendItemHeadingSplitText", function(t, e) {
    function i(e, i, s, n, r, a, o, l) {
        if (r || o) {
            this.id = i, this.node = t("#" + i), this.slider = e, this.splitText = !1;
            var h = this.node.find("a");
            h.length && (this.node = h), this.slider.started(t.proxy(this.started, this, s, n, r, a, o, l))
        }
    }
    var s = {
        opacity: 1,
    ...
    return i.prototype.started = function(e, i, s, n, r, a) {
        this.transformOrigin = e, this.backfaceVisibility = i;
        var o = {
            chars: 0,
            words: 0,
            lines: 0
        };
        s ? (this.splitTextIn = this.optimize(s.data, n), o[this.splitTextIn.mode] = 1) : this.splitTextIn = !1, r ? (this.splitTextOut = this.optimize(r.data, a), o[this.splitTextOut.mode] = 1) : this.splitTextOut = !1;
        var l = [];
        for (var h in o) o[h] && l.push(h);
        o.chars && !o.words && l.push("words"), "words,chars" == o && (o = "chars"), this.mode = o, this.modes = l, this.layer = this.node.closest(".n2-ss-layer").on("refreshTimeline." + this.id, t.proxy(this.refreshTimeline, this)).on("needExtendTimelineIn." + this.id, t.proxy(this.needExtendTimelineIn, this)).on("layerExtendTimelineIn." + this.id, t.proxy(this.extendTimelineIn, this)).on("needExtendTimelineOut." + this.id, t.proxy(this.needExtendTimelineOut, this)).on("layerExtendTimelineOut." + this.id, t.proxy(this.extendTimelineOut, this)), NextendTween.set(this.layer, {
            perspective: 1e3
        }), this.node.css("text-rendering", "auto")
    }, i.prototype.refreshTimeline = function() {
        if (this.needExtendTimelineIn() || this.needExtendTimelineOut()) {
            this.splitText && (this.splitText.revert(), this.splitText = !1), this.splitText = new NextendSplitText(this.node, {
                type: this.modes.join(",")
            });
            for (var t in this.mode) this.mode[t] && NextendTween.set(this.splitText[t], {
                transformOrigin: this.transformOrigin,
                backfaceVisibility: this.backfaceVisibility
            })
        }
    }, i.prototype.needExtendTimelineIn = function() {
        return !!this.splitTextIn
    }, i.prototype.extendTimelineIn = function(e, i, n) {
        if (this.splitTextIn) {
            var r = this.splitTextIn;
            this._animate(i, "staggerFromTo", r.mode, r.sort, r.duration, t.extend(!0, {}, r.from), t.extend(!0, {
                ease: r.ease
            }, s), r.stagger, n + r.delay)
        }
    }, i.prototype.needExtendTimelineOut = function() {
        return !!this.splitTextOut
    }, i.prototype.extendTimelineOut = function(e, i, n) {
        if (this.splitTextOut) {
            var r = this.splitTextOut;
            this._animate(i, "staggerFromTo", r.mode, r.sort, r.duration, t.extend(!0, {}, s), t.extend(!0, {
                ease: r.ease
            }, r.from), -r.stagger, n + r.delay)
        }
    }, i.prototype._animate = function(e, i, s, n, r, a, o, l, h) {
        var d = t.extend([], this.splitText[s]),
            p = null;
        switch (n) {
            case "reversed":
                d.reverse();
            ...
            case "center":
                var u = [];
                for (p = []; d.length > 1;) u.push(d.shift()), p.push(d.pop());
                1 == d.length && u.push(d.shift()), d = u, "center" == n && (d.reverse(), p.reverse());
                break;
            case "sideShifted":
            case "centerShifted":
                for (var u = []; d.length > 1;) u.push(d.shift()), u.push(d.pop());
                1 == d.length && u.push(d.shift()), d = u, "centerShifted" == n && d.reverse()
        }
        e[i](d, r, a, o, l, h), p && p.length && e[i](p, r, a, o, l, h)
    ...
    function i(e, i, n) {
        this.state = {
            ...
            center: 0,
            reset: 0
        }, n), this.slide = e.findSlideByElement(this.videoPlayer), this.videoPlayer.videoWidth > 0 ? this.initVideoPlayer() : this.videoPlayer.addEventListener("loadedmetadata", t.proxy(this.initVideoPlayer, this)), this.playerElement.prop("volume", this.playerElement.data("volume"))
    }
    var s = 1;
    return i.prototype.initVideoPlayer = function() {
        ...
        }, this)), (this.isStatic || -1 !== t.inArray(this.slide, this.slider.getVisibleSlides(this.slider.currentSlide))) && this.setState("slide", !0, !0), 1 === parseInt(this.parameters.autoplay) && this.initAutoplay(), this.isStatic || (this.slider.sliderElement.on("mainAnimationStart", t.proxy(function(e, i, s, n, r) {
            -1 === t.inArray(this.slide, this.slider.getVisibleSlides(this.slider.slides[n])) ? this.setState("slide", !1, !0) : this.setState("slide", !0, !0)
        ...
        }, this))), N2Classes.ScrollTracker.add(this.playerElement, "lazy", t.proxy(function() {
            this.setState("scroll", !0, !0)
        }, this), t.proxy(function() {
        ...
        this.safeCallback(t.proxy(function() {
            this.promise = this.videoPlayer.play(), this.slider.sliderElement.trigger("mediaStarted", this.playerId)
        }, this))
    }, i.prototype.safePlay = function() {
        this.safeCallback(t.proxy(function() {
    ...
    function i(e, i, s, n, r, a) {
        this.state = {
            scroll: !1,
            slide: !1,
            play: !1,
            continuePlay: !1
        }, this.readyDeferred = t.Deferred(), this.slider = e, this.playerId = i, this.start = a, this.parameters = t.extend({
            ...
            t("#" + this.playerId).on("click.vimeo n2click.vimeo", t.proxy(function(e) {
                t(e.currentTarget).off(".vimeo"), e.preventDefault(), e.stopPropagation(), this.initVimeoPlayer(), this.safePlay()
            }, this))
        }, this))
    }
    return i.vimeoDeferred = null, i.prototype.ready = function(e) {
        ...
        var i = this.playerElement.parent().parent();
        this.player.on("play", t.proxy(function() {
            ...
            this.setState("continuePlay", !0), this.setState("scroll", !1, !0)
        }, this)), (this.isStatic || -1 !== t.inArray(this.slide, this.slider.getVisibleSlides(this.slider.currentSlide))) && this.setState("slide", !0, !0), 1 === parseInt(this.parameters.autoplay) && this.slider.visible(t.proxy(this.initAutoplay, this)), this.playerElement.parent().css("background", ""), this.readyDeferred.resolve()
    }, i.prototype.initAutoplay = function() {
        this.isStatic ? (this.setState("play", !0), this.setState("slide", !0, !0)) : (this.slider.sliderElement.on("mainAnimationComplete", t.proxy(function(e, i, s, n, r) {
    ...
    function i(e, i, s, n) {
        if (this.state = {
                ...
                play: !1,
                continuePlay: !1
            }, this.readyDeferred = t.Deferred(), this.slider = e, this.playerId = i, this.parameters = t.extend({
                ...
                query: [],
                playsinline: 0
            }, s), 1 === parseInt(this.parameters.autoplay) && (navigator.userAgent.toLowerCase().indexOf("android") > -1 || n2const.isIOS)) {
            this.parameters.autoplay = 0;
            try {
                "playsInline" in document.createElement("video") && (this.parameters.autoplay = 1, this.parameters.playsinline = 1, this.parameters.volume = 0)
            } catch (r) {}
        }
        1 === parseInt(this.parameters.autoplay) || !n || n2const.isMobile ? this.ready(t.proxy(this.initYoutubePlayer, this)) : t("#" + this.playerId).on("click.youtube n2click.youtube", t.proxy(function(e) {
            t(e.currentTarget).off(".youtube"), e.preventDefault(), e.stopPropagation(), this.ready(t.proxy(function() {
    ...
    return i.YTDeferred = null, i.prototype.ready = function(s) {
        ...
        var e = t("#" + this.playerId),
            i = e.closest(".n2-ss-layer");
        ...
        1 == this.parameters.center && (s.controls = 0, s.showinfo = 0), 1 != this.parameters.controls && (s.autohide = 1, s.controls = 0), +(navigator.platform.toUpperCase().indexOf("MAC") >= 0 && navigator.userAgent.search("Firefox") > -1) && (s.html5 = 1);
        for (var n in this.parameters.query) this.parameters.query.hasOwnProperty(n) && (s[n] = this.parameters.query[n]);
                ...
                onStateChange: t.proxy(function(t) {
                    switch (t.data) {
                        ...
                        case YT.PlayerState.ENDED:
                            1 == this.parameters.loop ? (this.player.seekTo(0), this.player.playVideo()) : (this.isStatic || this.slider.sliderElement.trigger("mediaEnded", this.playerId), i.triggerHandler("n2stop"), this.setState("play", !1))
                    }
                }, this)
            }
        }), this.playerElement = t("#" + this.playerId), this.slide = this.slider.findSlideByElement(this.playerElement), 1 == this.parameters.center && (this.playerElement.parent().css("overflow", "hidden"), this.onResize(), this.slider.sliderElement.on("SliderResize", t.proxy(this.onResize, this)))
    }, i.prototype.onReady = function() {
        var e = parseFloat(this.parameters.volume);
        ...
        }, this))), this.readyDeferred.resolve(), N2Classes.ScrollTracker.add(this.playerElement, "lazy", t.proxy(function() {
            this.setState("scroll", !0, !0)
        }, this), t.proxy(function() {
            this.setState("continuePlay", !0), this.setState("scroll", !1, !0)
        }, this))
